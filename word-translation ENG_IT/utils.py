...
#read subset to create PNG spaces of Eng and It
dm_dict_en = readDM('data/english.subset.dm')
dm_dict_it = readDM('data/italian.subset.dm')

#read subset to create PNG of words in pairs
dm_dict_en_pairs = readDM('data/eng_pairs_subset.dm')
dm_dict_it_pairs = readDM('data/ita_pairs_subset.dm')
